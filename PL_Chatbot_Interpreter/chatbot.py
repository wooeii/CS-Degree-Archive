from common import model, client, fetch_genre_mood_recommendations
import base64
import json
...
class Chatbot:
    ...
    def recommend_music(self, genre=None, mood=None):
        message = f"장르: {genre}, 분위기: {mood}에 맞는 음악을 추천할게!"
        self.context.append({"role": "assistant", "content": message})
        recommendations = fetch_genre_mood_recommendations(genre=genre, mood=mood)
